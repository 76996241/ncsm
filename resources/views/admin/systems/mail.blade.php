                    ...
                    <div class="tpl-form-body tpl-form-line">
                        <form class="am-form tpl-form-line-form" enctype="multipart/form-data" action="{{ route('systemsUpdate') }}" method="post" >
                            ...
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label"> 邮件服务器地址 <span class="tpl-form-line-small-title">Smtp</span></label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" id="user-name"  name="system['systems_smtp']" value="{{ $data['system']['systems_smtp'] }}">
                                    <small>请填写Smtp。</small>
                                </div>
                            </div>

                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label"> 邮件服务器用户名 <span class="tpl-form-line-small-title">Username</span></label>
                                <div class="am-u-sm-9">
                                    <input  type="text" class="tpl-form-input" id="doc-ta-1" placeholder="" name="system['systems_smtpuser']" value="{{ $data['system']['systems_smtpuser'] }}">
                                    <small>请填写Username。</small>
                                </div>
                            </div>

                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label"> 邮件服务器密码 <span class="tpl-form-line-small-title">Password</span></label>
                                <div class="am-u-sm-9">
                                    <input  type="text" class="tpl-form-input" id="doc-ta-2" placeholder="" name="system['systems_smtppass']" value="{{ $data['system']['systems_smtppass'] }}">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="hidden" id="url" name="url" value="mail">
