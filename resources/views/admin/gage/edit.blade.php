        ...
        <div class="tpl-block">
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" enctype="multipart/form-data" action="{{ route('GageUpdate') }}" method="post" >
                        {{ csrf_field() }}
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label"> 标题 <span class="tpl-form-line-small-title">Title</span></label>
                            <div class="am-u-sm-9">
                                <input type="text" class="tpl-form-input" id="gage-title"  name="gage-title" value="{{ old('gage-title') ? old('gage-title') : $data['gage']['title']}}">
                                <small></small>
                            </div>
                        </div>
                        <div class="am-form-group">
                        ...
                        <div class="am-form-group">
                            <label for="user-phone" class="am-u-sm-3 am-form-label">量具品牌分类 <span class="tpl-form-line-small-title">Type</span></label>
                            <div class="am-u-sm-9" style="width: 75%">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <textarea  type="text" class="tpl-form-input" id="gage-introduce" placeholder="" name="gage-introduce">{{ old('gage-introduce') ? old('gage-introduce') : $data['gage']['introduce'] }}</textarea>
                                <small></small>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9"  style="height: 173px">
                                <div class="am-form-group am-form-file">
                                    ...
                                    <input id="gage-images" type="file" name="gage-images" value="{!! old('gage-images') ? old('gage-images') : $data['gage']['images'] !!}">
                                </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <script id="ueditor" type="text/plain" name="gage-content"  >{!! old('gage-content') ? old('gage-content') : $data['gage']['content'] !!}</script>
                        ...
                        <input type="hidden" name="id" value="{{ $data['gage']['id'] }}">
...
@section('footerJsCss')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            GageAdd();
            GageAddHrand();
            OneFileImg('gage-images','{{ asset('/upload/'.$data['gage']['images']) }}');

            //历史信息
            var type="{!! old('gage-type') ? old('gage-type') : $data['gage']['type'] !!}";
        ...
        function GageAddHrand() {
            var key="1";
            var ids="{{ $data['hrand'] }}";
            var hrand="{!! old('gage-hrand') ? old('gage-hrand') : $data['gage']['hrand'] !!}";
            $.get("{{ route('gageselect') }}?id="+ids+"&&key="+key+"&&type="+hrand, function(data){
