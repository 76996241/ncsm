...
<div id="js-alert-box" class="alert-box">
    <svg class="alert-circle" width="234" height="234">
        <circle cx="117" cy="117" r="108" fill="#FFF" stroke="#{{ $data['status']  }}" stroke-width="17"></circle>
...
<script type="text/javascript">
    function alertSet(e) {
        document.getElementById("js-alert-box").style.display = "block",
            document.getElementById("js-alert-head").innerHTML = '<p>'+e+'</p>';
        var t = {{ $data['jumpTime'] }},
...
<script>alertSet('{!! $data['message'] !!}');</script>
