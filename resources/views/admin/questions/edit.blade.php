        ...
        <div class="tpl-block">
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" enctype="multipart/form-data" action="{{ $data['QuestionsUpdate'] }}" method="post" >
                        {{ csrf_field() }}
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label"> 试题主题 <span class="tpl-form-line-small-title">Title</span></label>
                            <div class="am-u-sm-9">
                                <input type="text" class="tpl-form-input" id="questions-title"  name="questions-title" value="{{ old('questions-title') ? old('questions-title') : $data['question']['title']}}">
                                <small></small>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9"  style="height: 173px">
                                <div class="am-form-group am-form-file">
                                    ...
                                    <input id="questions-images" type="file" name="questions-images" value="{!! old('questions-images') ? old('questions-images') : $data['question']['images'] !!}">
                                </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <script id="ueditor" type="text/plain" name="questions-content"  >{!! old('questions-content') ? old('questions-content') : $data['question']['content'] !!}</script>
...
@section('footerJsCss')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            OneFileImg('questions-images','{{ asset('/upload/'.$data['question']['images']) }}');

            //历史信息
            var type="{!! old('questions-type') ? old('questions-type') : $data['question']['type'] !!}";
        })
        ...
        function GetText() {
            ...
            GetErr('title','questions',title,'请填中文或英文10-50字左右。');
