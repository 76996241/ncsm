        ...
        <div class="tpl-block">
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" enctype="multipart/form-data" action="{{ route('NewsInsert') }}" method="post" >
                        {{ csrf_field() }}
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label"> 标题 <span class="tpl-form-line-small-title">Title</span></label>
                            <div class="am-u-sm-9">
                                <input type="text" class="tpl-form-input" id="news-title"  name="news-title" value="{{ old('news-title') }}">
                                <small></small>
                            </div>
                        </div>
                        <div class="am-form-group">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <textarea  type="text" class="tpl-form-input" id="news-introduce" placeholder="" name="news-introduce">{{ old('news-introduce') }}</textarea>
                                <small></small>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9"  style="height: 173px">
                                <div class="am-form-group am-form-file">
                                    ...
                                    <input id="news-images" type="file" name="news-images" value="">
                                </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <script id="ueditor" type="text/plain" name="news-content"  >{!! old('news-content') !!}</script>
...
@section('footerJsCss')
    ...
    <script type="text/javascript">
        ...
        function NewsAdd() {
            ...
            var  id="{{ $data['pids'] }}";
            var key="1";
            $.get("{{ route('newsselect') }}?id="+id+"&&key="+key, function(data){
                $('#news-type').html(data.html);
            });
            //历史信息
            var type="{!! old('news-type') !!}";
            $("#news-type option[value="+type+"]").attr("selected", true);
        }
